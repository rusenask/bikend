...
.controller('NewParkCtrl', function($scope, $http, $ionicHistory, $state, ngFB) {
...
.controller('MybikeCtrl', function($scope, $http, $ionicHistory, $state) {
    $scope.mybike = {
              address: 'Big Ben',
              price: '6'
            };
